...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Dosen"))
        self.lblName.setText(_translate("Dialog", "Nama"))
        self.lblHours.setText(_translate("Dialog", "Waktu Tersedia"))
        self.btnFinish.setText(_translate("Dialog", "Simpan"))
        self.btnCancel.setText(_translate("Dialog", "Batalkan"))
