...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Kelas/Ruangan"))
        self.lblName.setText(_translate("Dialog", "Nama"))
        self.groupBox.setTitle(_translate("Dialog", "Tipe"))
        self.radioLec.setText(_translate("Dialog", "Kuliah"))
        self.radioLab.setText(_translate("Dialog", "Lab"))
        self.btnFinish.setText(_translate("Dialog", "Selesai"))
        self.btnCancel.setText(_translate("Dialog", "Batal"))
