...
# Digenerate dari file 'main.ui' di folder qt_ui

# Mengimport library yang dibutuhkan untuk UI
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Optimasi Penjadwalan Algoritma Genetika"))
        ...
        self.btnInstrAdd.setText(_translate("MainWindow", "Tambahkan Dosen"))
        self.btnInstrImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Dosen"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Operation"))
        self.btnRoomAdd.setText(_translate("MainWindow", "Tambahkan Kelas"))
        self.btnRoomImport.setText(_translate("MainWindow", "Import dari CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Kelas"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Operation"))
        self.btnSubjAdd.setText(_translate("MainWindow", "Tambah Mata Kuliah"))
        self.btnSubjImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSubjects), _translate("MainWindow", "Mata Kuliah"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Operation"))
        self.btnSecAdd.setText(_translate("MainWindow", "Add Section"))
        # self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "Sesi"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Operation"))
        self.btnScenGenerate.setText(_translate("MainWindow", "Generate"))
        self.btnScenResult.setText(_translate("MainWindow", "Lihat Hasil"))
        ...
        # self.label_4.setToolTip(_translate("MainWindow", "Waktu Buka Universitas"))
        # self.label_4.setText(_translate("MainWindow", "Waktu Dimulai"))
        ...
        # self.label_5.setText(_translate("MainWindow", "Waktu Selesai"))
        ...
        # self.label_20.setText(_translate("MainWindow", "Populasi Elit"))
        ...
        # self.label_12.setText(_translate("MainWindow", "Maksimum Fitness"))
        ...
        # self.label_11.setText(_translate("MainWindow", "Mutation Rate"))
        ...
        self.actionAdd_Instructor.setText(_translate("MainWindow", "Tambah Dosen"))
        self.actionView_Instructors.setText(_translate("MainWindow", "Lihat Dosen"))
        self.actionAdd_Room.setText(_translate("MainWindow", "Tambah Kelas"))
        self.actionView_Rooms.setText(_translate("MainWindow", "Lihat Kelas"))
        self.actionAdd_Subject.setText(_translate("MainWindow", "Tambah Mata Kuliah"))
        self.actionView_Subjects.setText(_translate("MainWindow", "Lihat Mata Kuliah"))
        self.actionAdd_Sections.setText(_translate("MainWindow", "Tambah Sesi"))
        self.actionView_Sections.setText(_translate("MainWindow", "Lihat Sesi"))
        self.actionImport.setText(_translate("MainWindow", "Import"))
        self.actionExport.setText(_translate("MainWindow", "Export"))
        self.actionView_Results.setText(_translate("MainWindow", "Lihat Hasil"))
        ...
        self.actionScenario_Summary.setText(_translate("MainWindow", "Ringkasan Skenario"))
        self.actionGenerate_2.setText(_translate("MainWindow", "Generate"))
        self.actionView_Results_2.setText(_translate("MainWindow", "Lihat Hasil"))
        self.actionInstructions.setText(_translate("MainWindow", "Dosen"))
