...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Mata Kuliah"))
        self.lblHours.setText(_translate("Dialog", "SKS"))
        self.lblName.setText(_translate("Dialog", "Name"))
        self.groupBox_2.setTitle(_translate("Dialog", "Bagi Jadwal"))
        self.radioYes.setText(_translate("Dialog", "Ya"))
        self.radioNo.setText(_translate("Dialog", "Tidak"))
        self.groupBox.setTitle(_translate("Dialog", "Tipe"))
        self.radioAny.setText(_translate("Dialog", "Apa Saja"))
        self.radioLec.setText(_translate("Dialog", "Kuliah"))
        self.radioLab.setText(_translate("Dialog", "Lab"))
        self.lblCode.setText(_translate("Dialog", "Kode"))
        self.lblDesc.setText(_translate("Dialog", "Deskripsi"))
